sap.ui.define([
    ...
    return {
        getCustomAppStateDataExtension: function (oCustomData) {
            ...
            if (oCustomData) {
                var oCustomField1 = this.oView.byId("CurrencyCode");
                if (oCustomField1) {
                    oCustomData.CurrencyCode = oCustomField1.getSelectedKey();
                }
            }
        },
        restoreCustomAppStateDataExtension: function (oCustomData) {
            ...
            if (oCustomData) {
                if (oCustomData.CurrencyCode) {
                    var oComboBox = this.oView.byId("CurrencyCode");
                    oComboBox.setSelectedKey(
                        oCustomData.CurrencyCode
                    );
                }
            }
        },
        onBeforeRebindTableExtension: function(oEvent) {
            ...
            if (oSmartFilterBar instanceof SmartFilterBar) {
                var oCustomControl = oSmartFilterBar.getControlByKey("fragCurrencyKey");
